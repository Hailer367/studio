      ...
      <DialogContent className="max-w-md w-full text-center bg-card/80 border-primary/50 p-8">
        <DialogHeader>
          ...
          <DialogDescription className="text-center">
            The coin will decide your fate.
          </DialogDescription>
        </DialogHeader>
        
        <div className="grid grid-cols-3 items-center justify-items-center w-full gap-4 my-8">
            ...
            <div className="flex flex-col items-center gap-2">
                ...
                <p className="font-bold text-base">{opponent.name}</p>
            </div>
        </div>
